...
namespace Sample01
{
    public class Program
    {
        ...
        public static IWebHostBuilder CreateWebHostBuilder(string[] args) =>
            WebHost.CreateDefaultBuilder(args)//使用默认的配置信心来初始化一个新的IWebHostBuilder实例
                .ConfigureAppConfiguration((hostContext, config) => //.UseStartup<Startup>();//为Web Host指定Startup类
               {
